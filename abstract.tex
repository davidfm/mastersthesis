...
Hummingbird is also presented in this work. The idea behind its development and its architecture plays an important role in the software developed in this thesis\\

Based on the cooperation with the the scientists working on the ESTCube project a completely configurable software has been designed and implemented. This software is prepared to be fully integrated with Hummingbird when necessary.
\vfill
