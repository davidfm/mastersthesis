...
In order to understand how  the satellites communicate with Earth, the very basics of satellite communications are covered in this chapter. The first section describes what orbits are, what elements describe them and how that information can be delivered by a computer. Afterwards, the different types of data exchanged by the satellite and the ground station will be covered. The last section of the chapter presents what a ground station is, its hardware and software components and how it communicates with a satellite in space.
...
The satellite ground tracks are the projection of its orbit onto Earth, they are used to clearly explain how the satellites move in reference to an observer on the ground. An example of this can be Figure \ref{f2.4}.
...
Since the orbital plane does not move in inertial space, the satellite's orbit will always be the same \citep{BARN}. If Earth did not move the representation of the orbit would be a single line, as the ground track would continuously repeat. However, Earth rotates at 1600 km/hr. Thus, even if the orbit does not change, from the Earth-based observer's point of view it appears to shift to the west.

This poses a challenge to the communication with the satellite. Since it is visible, as a fast moving object, from a certain location on the ground for very short periods of time the communications antenna needs track the satellite in order to handle the communication. The ground tracks for this matter and are generated based on two line element sets, which will be covered in the next section.
...
The following snippet shows an example of a TLE for the International Space Station. The meaning of its different parts is explained in Tables \ref{Table2.3} and \ref{Table2.4}.
...
\begin{tabular}{|c|c|c|}
\hline
\begin{tabular}[x]{@{}c@{}}\textbf{Name}\end{tabular} &
\begin{tabular}[x]{@{}c@{}}\textbf{Frequency Range}\end{tabular} &
\begin{tabular}[x]{@{}c@{}}\textbf{Wavelength}\end{tabular}\\
\hline
\begin{tabular}[x]{@{}c@{}}VHF\end{tabular} &
\begin{tabular}[x]{@{}c@{}}30 to 300 Mhz\end{tabular} &
\begin{tabular}[x]{@{}c@{}}10 to 1 m\end{tabular}\\
\hline
\begin{tabular}[x]{@{}c@{}}UHF\end{tabular} &
\begin{tabular}[x]{@{}c@{}}0.3 to 3 Ghz\end{tabular} &
\begin{tabular}[x]{@{}c@{}}1 to 0.1 m\end{tabular}\\
\hline
\begin{tabular}[x]{@{}c@{}}S-Band\end{tabular} &
\begin{tabular}[x]{@{}c@{}}2 to 4 Ghz\end{tabular} &
\begin{tabular}[x]{@{}c@{}}15 to 7.5 cm\end{tabular}\\
\hline
\begin{tabular}[x]{@{}c@{}}X-Band\end{tabular} &
\begin{tabular}[x]{@{}c@{}}8 to 12 Ghz\end{tabular} &
\begin{tabular}[x]{@{}c@{}}37.5 to 25 mm\end{tabular}\\
\hline
\end{tabular}
\caption{Common radio frequencies used for amateur satellite communications.}
  \label{Table2.5}
\end{table}
