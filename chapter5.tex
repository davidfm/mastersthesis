...
\caption{Class diagram. Loading the calibration information.}
\label{f5.2}
\end{figure}
...
\caption{Sequence diagram. Loading the calibration information.}
\label{f5.3}
\end{figure}
